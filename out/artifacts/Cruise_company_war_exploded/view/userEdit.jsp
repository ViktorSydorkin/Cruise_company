        ...
        <form action="${pageContext.request.contextPath}/admin/editUser" method="post">
            ...
            <div class="form-fields">
                <div class="form-field">
                    <input name="name" type="text" placeholder="Name" value="${param.name}" required
                           pattern="^([A-ZА-ЯЄІЇ])((['][A-Zа-яєії])?)([a-zа-яєії]+)([-][A-ZА-ЯІЇ]((['][A-Zа-яєії])?)[a-zа-яєії']+)?"
                           title="Example: John, O'Connor, Andrew-Wall">
                </div>
                <div class="form-field">
                    <input name="surname" type="text" placeholder="Surname" value="${param.surname}" required
                           pattern="^([A-ZА-ЯЄІЇ])((['][A-Zа-яєії])?)([a-zа-яєії]+)([-][A-ZА-ЯІЇ]((['][A-Zа-яєії])?)[a-zа-яєії']+)?"
                           title="Example: John, O'Connor, Andrew-Wall">
                </div>
                <div class="form-field">
                ...
                <div class="form-field">
                    <input name="language" type="number" placeholder="Preferred language" min="1" max="2" value="${param.language}">
                </div>
            </div>
