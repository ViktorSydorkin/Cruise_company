...
<main class="main-settings">
    ...
    <div class="register-form-container">
        <form action="${pageContext.request.contextPath}/admin/editLiner" method="post" enctype="multipart/form-data">
            <h1 class="form-title">
                Editing liner
            </h1>
            <div class="form-fields">
                <div class="form-field">
                    <input name="liner_name" type="text" placeholder="Liner name" required
                           value="${param.name}" pattern="^[A-Z][a-z' ]{1,}">
                </div>
                <div class="form-field">
                    <input name="capacity" type="number" placeholder="Capacity" min="1" required
                           value="${param.capacity}">
                </div>
                <div class="form-field">
                    <input name="deck_amount" type="number" min="1" max="20" placeholder="Deck amount" required
                           value="${param.deck_amount}">
                </div>
                <div class="form-field">
